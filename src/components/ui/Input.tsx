...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full text-left">
      ...
      <input
        id={inputId}
        className={`w-full rounded-md border bg-white px-3 py-2 text-sm text-neutral-900 placeholder:text-neutral-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 transition-colors ${
          error
